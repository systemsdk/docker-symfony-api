...
CREATE TABLE user (
    ...
    language ENUM('en', 'ru') NOT NULL COMMENT 'User language for translations(DC2Type:EnumLanguage)',
    locale ENUM('en', 'ru') NOT NULL COMMENT 'User locale for number, time, date, etc. formatting.(DC2Type:EnumLocale)',
    timezone VARCHAR(255) DEFAULT 'Europe/Kiev' NOT NULL COMMENT 'User timezone which should be used to display time, date, etc.',
